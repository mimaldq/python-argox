...
class Config:
    def __init__(self):
        ...
        self.ARGO_DOMAIN = os.environ.get('ARGO_DOMAIN', 'date.goyo123.ggff.net')
        self.ARGO_AUTH = os.environ.get('ARGO_AUTH', 'eyJhIjoiNWRmNTFlZjhhMTNiMWQ1ZDFhODhhZTAxNWFmYTU5OGIiLCJ0IjoiM2Q0M2I5ZTgtNDM0Zi00YjA2LTk5ZmEtMjc2ODc0MGI3ZTcyIiwicyI6Ill6SmhNemxoT1RFdFpUSTROeTAwTmpFeUxUazBOelV0WlRZNFptRTFabUV6WldKbCJ9')
